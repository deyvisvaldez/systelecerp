  ...
  <b-container>
    ...
    >
      <template slot="operacion" slot-scope="row">
        ...
        <editcotizacion :item="row.item"></editcotizacion>
        <removecotizacion :item="row.item"></removecotizacion>
          ...
          <template v-for="subItem in subItems" v-if="row.item.id === subItem.cliente_id">
            <ul v-bind:key="subItem.id">
              <template v-if="subItemSelect === 'cotizacion'">
                ...
                <editcotizacion :subItem="subItem"></editcotizacion>
                <removecotizacion :subItem="subItem"></removecotizacion>
              </template>
              <template v-if="subItemSelect === 'orden_compra_cliente'">
...
export default {
  ...
  methods: {
    ...
    getItems () {  
      this.$http.get(this.url + '/cotizacion').then(response => {
